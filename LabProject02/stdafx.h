...
constexpr unsigned int FRAMEBUFFER_WIDTH{ 640 };
constexpr unsigned int FRAMEBUFFER_HEIGHT{ 480 };

constexpr DWORD DIR_FORWARD{ 0x01 };
constexpr DWORD DIR_BACKWARD{ 0x02 };
constexpr DWORD DIR_LEFT{ 0x04 };
constexpr DWORD DIR_RIGHT{ 0x08 };
...
namespace Matrix4x4
{
	inline XMFLOAT4X4 Identity()	// 단위 행렬을 생성하여 반환한다.
	{
